...
var api_url = new URL("http://10.36.75.57/quiz.json");
...
fetch(api_url)
  ...
  .then((results) => {
    ...
    myarr.forEach(element => {
      ...
      ques.fun_fact=element.fun_fact;
      questions.push(ques)
      qindex++;
    });
    console.log("Fetching api done");
    questions = shuffle(questions) // randomize questions
    questions = questions.slice(0, 10) // Show first 10 questions only
    hideloader();
    return questions;
  })
}
